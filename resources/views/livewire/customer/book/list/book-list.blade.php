        <div class='d-flex'>
            ...
            <div class='flex-grow-1 border-2 bg-white d-flex flex-column px-1 px-sm-2 rounded' x-data="{
                ...
                x-init="checkScreenWidth()" x-on:resize.window="checkScreenWidth()">
                <form class="d-flex align-items-center w-100 mt-3" role="search" wire:submit="searchBook">
                    ...
                    <input wire:model="searchBookInput" id="search_book" class="form-control search_form"
                        type="search" placeholder="Search book by name" aria-label="Search for books">
                </form>
                <div class='d-flex mt-3'>
                    <div class='d-sm-flex'>
                        ...
                        <div class='ms-sm-3 mt-3 mt-sm-0'>
                            <select id='listLimit' class="form-select pointer"
                                aria-label="Select number of books per page" wire:model.live="booksPerPage"
                                x-on:change="$wire.resetPageIndex()">
                    ...
                    <div class="btn-group d-none d-xl-inline-flex ms-3">
                        <button name="previous" type="button"
                            class="btn btn-light fw-medium border border-1 border-secondary"
                            wire:click="previousPage()" {{ $pageIndex === 1 ? 'disabled' : '' }}>&lt;</button>
                        <button type="button" class="btn btn-light fw-medium border border-1 border-secondary"
                            disabled name="offset">{{ $pageIndex }}</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form wire:submit="searchCategory">
                                ...
                                <div class="d-flex align-items-center">
                                    <button title='Submit search form'
                                        class="p-0 border-0 position-absolute bg-transparent mb-1 ms-2"
                                        type="submit">
                            ...
                            <form class='mt-4' wire:submit="searchPublisher">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input id="search_publisher_modal" class="form-control search_form"
                                        type="search" placeholder="Search publisher" aria-label="Search publisher"
