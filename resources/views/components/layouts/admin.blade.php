                    ...
                    <div class="collapse navbar-collapse mt-2 mt-lg-0 me-lg-2 bg-white px-3"
                        ...
                        @php
                            ...
                            if (str_contains($tab, 'book')) {
                                $activeTab = 'book';
                            } elseif (str_contains($tab, 'category')) {
                                $activeTab = 'category';
                            } elseif (str_contains($tab, 'customer')) {
                                $activeTab = 'customer';
                            } elseif (str_contains($tab, 'coupon')) {
                                $activeTab = 'coupon';
                            } elseif (str_contains($tab, 'request')) {
                                $activeTab = 'request';
                            } elseif (str_contains($tab, 'statistic')) {
                                $activeTab = 'statistic';
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item dropdown mx-2">
                                <p class="nav-link m-0 fs-5 d-inline-block {{ in_array($activeTab, ['book', 'category', 'customer', 'coupon', 'request']) ? 'activeTab' : '' }}"
                                    ...
                                    @else
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.authentication.index') }}">Book</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.authentication.index') }}">Category</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.authentication.index') }}">Customer</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.authentication.index') }}">Coupon</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.authentication.index') }}">Request</a>
                                        </li>
                                    @endif
                                </ul>
                            </li>
                            <li class="nav-item mx-2">
                                @if (auth()->check())
                                    <a class="nav-link d-inline-block fs-5 {{ $activeTab === 'statistic' ? 'activeTab' : '' }}"
                                        href="{{ route('admin.statistic.index') }}">Statistic</a>
                                @else
                                    <a class="nav-link d-inline-block fs-5"
                                        href="{{ route('admin.authentication.index') }}">Statistic</a>
                                @endif
                            </li>
                            @if (auth()->check())
                                ...
                                <li class="nav-item ms-2">
                                    <form id="logout-form" action="{{ route('admin.authentication.logout') }}"
                                        method="POST" style="display: none;">
                                        @csrf
                                    </form>
                                    <a class="nav-link d-inline-block fs-5 text-danger text-nowrap"
                                        href="{{ route('admin.authentication.logout') }}"
                            ...
                            @else
                                <li class="nav-item ms-2">
                                    <a class="nav-link d-inline-block fs-5"
                                        href="{{ route('admin.authentication.index') }}">Profile</a>
                                </li>
                                <li class="nav-item ms-2">
