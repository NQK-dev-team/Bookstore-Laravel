                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                Please login to your email account again</h1>
                                                            <!--[if mso]></td></tr></table><![endif]-->
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Dear {{ $userName }},
                                                                </p>
                                                                ...
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">If you did not change
                                                                    your password, please contact us immediately to
                                                                    report any unauthorized access to your account.</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">If you have any issues or
                                                                    concerns regarding your account, please do not
                                                                    hesitate to contact our customer support team for
                                                                ...
                                                                <p style="line-height: 140%;">
                                                                    {{ env('MAIL_FROM_NAME', 'Bookstore-Laravel') }}</p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                ...
                                                                <a href="{{ route('customer.authentication.index') }}"
                                                                    target="_blank"
                        ...
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-33p33"
                                    ...
                                    <div
                                        style="background-color: #2980b9;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            <!--<![endif]-->
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <span><strong>How to protect your
                                                                        account</strong></span>
                                                            </h1>
                                                            <!--[if mso]></td></tr></table><![endif]-->
