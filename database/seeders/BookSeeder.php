...
class BookSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK1/The+Joy+of+PHP.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK2/Models+Attract+Women+Through+Honesty.png',
            'description' =>
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK3/Lord+of+Goblins%2C+Vol.+1+Definitive+Edition+(Lord+of+Goblins).png',
            'description' =>
        ...
        DB::table('books')->insert([
            ...
            'image' => "files/BOOK4/The+Hitchhiker's+Guide+to+the+Galaxy.png",
            'description' =>
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK5/The+Time+Machine.png',
            'description' =>
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK6/Pride+and+Prejudice.png',
            'description' =>
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK7/To+Kill+a+Mockingbird.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK8/The+Alchemist.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "files/BOOK9/The+Handmaid's+Tale.png",
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK10/Sapiens+A+Brief+History+of+Humankind.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK11/Dracula.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK12/One+Hundred+Years+of+Solitude.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK13/The+Martian.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK14/The+Fault+in+Our+Stars.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK15/Things+Fall+Apart.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK16/Murder+on+the+Orient+Express.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK18/The+Lord+of+the+Rings.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "files/BOOK19/The+Handmaid's+Tale.png",
            'description' => 'Margaret Atwood\'s popular dystopian novel The Handmaid\'s Tale explores a broad range of issues relating to power, gender, and religious politics. Multiple Golden Globe award-winner Claire Danes (Romeo and Juliet, The Hours) gives a stirring performance of this classic in speculative fiction, one of the most powerful and widely read novels of our time.',
            'created_at' => now(),
            'updated_at' => now(),
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK20/Sapiens+A+Brief+History+of+Humankind.png',
            'description' => 'From a renowned historian comes a groundbreaking narrative of humanity\'s creation and evolution - a #1 international bestseller - that explores the ways in which biology and history have defined us and enhanced our understanding of what it means to be "human".',
            'created_at' => now(),
            'updated_at' => now(),
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK21/The+Count+of+Monte+Cristo.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK22/Frankenstein.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "files/BOOK23/The+Hitchhiker's+Guide+to+the+Galaxy.png",
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK25/The+God+of+Small+Things.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK26/Echoes+of+Asgard.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK27/Money+Magic.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK28/Code+Red.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK29/Whisper+in+the+Wilds.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "files/BOOK30/The+Girl+with+the+Timekeeper's+Heart.png",
        ...
        DB::table('books')->insert([
            ...
            'image' => 'files/BOOK31/Lord+of+Goblins%2C+Vol.+2.png',
