...
class BookSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('books')->insert([
            ...
            'image' => 'BOOK1/The+Joy+of+PHP.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK2/Models+Attract+Women+Through+Honesty.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK3/Lord+of+Goblins%2C+Vol.+1+Definitive+Edition+(Lord+of+Goblins).png',
            'description' => 'Corruption. Greed. War. Lev is no stranger to the evils of the world, having spent a lifetime fighting the predatory system that ensnared the world\'s population and turned them into puppets for the leaders of humanity.'
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => "BOOK4/The+Hitchhiker's+Guide+to+the+Galaxy.png",
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK5/The+Time+Machine.png',
            'description' => 'When a Victorian scientist propels himself into the year 802,701 AD, he is initially delighted to find that suffering has been replaced by beauty, contentment and peace. Entranced at first by the Eloi, an elfin species descended from man, he soon realises that this beautiful people are simply remnants of a once-great culture - now weak and childishly afraid of the dark. But they have every reason to be afraid: in deep tunnels beneath their paradise lurks another race descended from humanity - the sinister Morlocks. And when the scientist\'s time machine vanishes, it becomes clear he must search these tunnels, if he is ever to return to his own era.'
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK6/Pride+and+Prejudice.png',
            'description' => 'One of Jane Austen\'s most beloved works, Pride and Prejudice, is vividly brought to life by Academy Award nominee Rosamund Pike (Gone Girl). In her bright and energetic performance of this British classic, she expertly captures Austen\'s signature wit and tone. Her attention to detail, her literary background, and her performance in the 2005 feature film version of the novel provide the perfect foundation from which to convey the story of Elizabeth Bennet, her four sisters, and the inimitable Mr. Darcy.'
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK7/To+Kill+a+Mockingbird.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "BOOK9/The+Handmaid's+Tale.png",
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK10/Sapiens+A+Brief+History+of+Humankind.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK12/One+Hundred+Years+of+Solitude.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK14/The+Fault+in+Our+Stars.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK15/Things+Fall+Apart.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK16/Murder+on+the+Orient+Express.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK18/The+Lord+of+the+Rings.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "BOOK19/The+Handmaid's+Tale.png",
            'description' => 'Margaret Atwood\'s popular dystopian novel The Handmaid\'s Tale explores a broad range of issues relating to power, gender, and religious politics. Multiple Golden Globe award-winner Claire Danes (Romeo and Juliet, The Hours) gives a stirring performance of this classic in speculative fiction, one of the most powerful and widely read novels of our time.'
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK20/Sapiens+A+Brief+History+of+Humankind.png',
            'description' => 'From a renowned historian comes a groundbreaking narrative of humanity\'s creation and evolution - a #1 international bestseller - that explores the ways in which biology and history have defined us and enhanced our understanding of what it means to be "human".'
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK21/The+Count+of+Monte+Cristo.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "BOOK23/The+Hitchhiker's+Guide+to+the+Galaxy.png",
            'description' => 'Seconds before the Earth is demolished to make way for a galactic freeway, Arthur Dent is plucked off the planet by his friend Ford Prefect, a researcher for the revised edition of The Hitchhiker\'s Guide to the Galaxy who, for the last 15 years, has been posing as an out-of-work actor.'
        ]);
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK25/The+God+of+Small+Things.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK26/Echoes+of+Asgard.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK29/Whisper+in+the+Wilds.png',
        ...
        DB::table('books')->insert([
            ...
            'image' => "BOOK30/The+Girl+with+the+Timekeeper's+Heart.png",
        ...
        DB::table('books')->insert([
            ...
            'image' => 'BOOK31/Lord+of+Goblins%2C+Vol.+2.png',
